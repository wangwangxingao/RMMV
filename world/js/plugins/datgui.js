...
/******/
/******/ 	//需要功能 The require function
/******/ 	function __webpack_require__(moduleId) {
/******/
/******/ 		//检查模块是否在缓存中 Check if module is in cache
/******/ 		if(installedModules[moduleId])
/******/ 			return installedModules[moduleId].exports;
/******/
/******/ 		//创建一个新的模块（并将其放入缓存） Create a new module (and put it into the cache)
...
/******/ 		};
/******/
/******/ 		// 执行模块功能 Execute the module function
/******/ 		modules[moduleId].call(module.exports, module, module.exports, __webpack_require__);
/******/
/******/ 		//将模块标记为加载 Flag the module as loaded
/******/ 		module.loaded = true;
/******/
/******/ 		//返回模块的导出 Return the exports of the module
/******/ 		return module.exports;
/******/ 	}
/******/
/******/
/******/ 	//公开模块对象（__webpack_modules__） expose the modules object (__webpack_modules__)
/******/ 	__webpack_require__.m = modules;
/******/
/******/ 	//暴露模块缓存 expose the module cache
/******/ 	__webpack_require__.c = installedModules;
/******/
/******/ 	// __webpack_public_path__
/******/ 	__webpack_require__.p = "";
/******/
/******/ 	//加载入口模块并返回导出 Load entry module and return exports
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * @param {Object} [params] 
	 * @param {String} [params.name] 这个GUI的名称。 The name of this GUI. 
	 * @param {Object} [params.load] 表示此GUI保存状态的JSON对象。 JSON object representing the saved state of
	 * this GUI.
	 * @param {Boolean} [params.auto=true]
	 * @param {dat.gui.GUI} [params.parent] 我嵌套的GUI ,The GUI I'm nested in.
	...
	var GUI = function GUI(pars) {
	  ...
	  /** @lends dat.gui.GUI.prototype */
	  {
	    ...
	    /**<code> GUI </ code>的名称。 用于文件夹 即文件夹的名称
	    ...
	    showname: {
	      ...
	      set: function set(v) {
	        ...
	        params.showname = v;
					if (titleRow) {
						titleRow.innerHTML= params.showname 
					}
	      }
	    },
	    /**<code> GUI </ code>是否已折叠
	    ...
	    closed: {
	      ...
	      set: function set(v) {
	        ...
	        if (_this.__closeButton) {
                //++
	          _this.__closeButton.innerHTML = v ? this.text_open :this.text_close;
	        }
	      }
        },
	    ...
	    text_open: {
	      get: function get() {
	        return params.text_open || GUI.TEXT_OPEN   ;
	      },
	      set: function set(v) {
	        // TODO Check for collisions among sibling folders
	        params.text_open = v;
	        if (_this.__closeButton) {
	          _this.__closeButton.innerHTML = params.text_open;
	        }
	      }
        },
        //+++
        text_close: {
	      get: function get() {
	        return params.text_close || GUI.TEXT_CLOSED   ;
	      },
	      set: function set(v) {
	        // TODO Check for collisions among sibling folders
	        params.text_close = v;
	        if (_this.__closeButton) {
	          _this.__closeButton.innerHTML = params.text_close;
	        }
	      }
	    },
	  ...
	  if (_common2.default.isUndefined(params.parent)) {
	    ...
	    this.__closeButton.innerHTML = this.text_close ;
	...
	/** @lends dat.gui.GUI */
	{
     ...
     /**添加绑定方法 ++
	   ...
	   * @instance
	   */
	  addFuns: function add(object, property,funs) { 
	    return _add(this, object, property, {
	 ...
	 /**++
	   ...
	   * @instance
	   */
      addObject: function addObject(object, param) {
          var o = {}
          var param = param || {}
          var args = param["args"]
          var argso = param["argso"] || {}
          var funs = param["funs"]
          var funso = param["funso"] || {}
          for (var property in object) {
              o[property] = _add(this, object, property, {
                  factoryArgs:( argso[property] || args || [])
              },( funso[property] || funs || {}));
          }
          return o
      },
     ...
     * @instance
     */
      addArray: function addArray(object, param) {
          var o = []
          var param = param || {}
          var args = param["args"]
          var argso = param["argso"] || {}
          var funs = param["funs"]
          var funso = param["funso"] || {}
          for (var property = 0; property < object.length; property++) {
              o[property] = _add(this, object, property, {
                  factoryArgs:( argso[property] || args || [])
              },( funso[property] || funs || {}));
          }
	   ...
	   * @instance
	   */
	  addColor: function addColor(object, property,funs) {
	    return _add(this, object, property, {
	      color: true
	    },funs);
	  },
	   ...
	   * @instance
	   */
	  removeIndex: function removeIndex(controllerId) {
        var controller = this.__controllers(controllerId)
        if(controller)
	    // TODO listening?
	    this.__ul.removeChild(controller.__li);
	    this.__controllers.splice(this.__controllers.indexOf(controller), 1);
	   ...
	   * @instance
	   */
	  addFolder: function addFolder(name,showname) {
	    // We have to prevent collisions on names in order to have a key
	    // by which to remember saved values
	    if (this.__folders[name] !== undefined) {
	      throw new Error('You already have a folder in this GUI by the' + ' name "' + name + '"');
	    }
	    var showname = showname || name
	    var newGuiParams = { name: name,showname:showname ,parent: this };
	...
	//_添加 (gui , 对象 ,属性 , 参数) 添加方法 ++
	function _add(gui, object, property, params, funs) {
		var showname  
		if( Array.isArray(property) ){ 
			var showname = property[1] || ""
			var property = property[0]
		}
		if(!showname && showname!=="" ){ showname = property } 
	  ...
	  name.innerHTML = controller.showname = showname
      ...
      //++
      if(funs){for(var n in funs){ _dom2.default.bind(li, n, funs[n].bind(controller))}}
	...
	function addSaveMenu(gui) {
      ...
      _dom2.default.addClass(button4, 'close');
