...
addTouch = function(name, obj) {
    touch[name] = obj
}



list = [{ name: "start", touch: 1 }, { name: "next", touch: 2 }]
...
e = [
    ...
    /**标签 */
    { "code": 118, "indent": 0, "parameters": [".2"] },
    /**跳转 */
    { "code": 119, "indent": 0, "parameters": [""] },
    {
        "code": 102,
        "indent": 0,
        "parameters": [
...
/**安装*/
Game_Interpreter.prototype.setup = function(obj) {
    //清除()
    this.clear();
    //对象 = 对象
    this._obj = obj;
...
/**对象*/
Game_Interpreter.prototype.obj = function() {
    //返回 对象
    return this._obj;
};
...
/**子返回*/
Game_Interpreter.prototype.childReturn = function() {
    //返回 更新等待计数() 或者 更新等待模式() 
    return this._childReturn;
};
/**子项返回*/
Game_Interpreter.prototype.setChildReturn = function(re) {
    //返回 更新等待计数() 或者 更新等待模式() 
    this._childReturn = re;
};

/**设置返回*/
Game_Interpreter.prototype.setReturn = function(re) {
    this._return = re;
};
/**返回*/
Game_Interpreter.prototype.return = function() {
    //返回 更新等待计数() 或者 更新等待模式() 
    return this._return;
};
...
Array.prototype.end = function(v) {
...
Game_Interpreter.prototype.command000 = function() {
...
/** 分歧开始*/
Game_Interpreter.prototype.command010 = function() {
    //返回 true
    return true;
};
/**
...
/** When [**] 当*/
Game_Interpreter.prototype.command011 = function() {
    //如果 (分支[缩进] !== 参数组[0])
    if (this.paramsResult(this._params)) {
        //跳分支()
        this.skipBranch();
...
/** 条件分歧结束*/
Game_Interpreter.prototype.command012 = function() {
    //返回 true
    return true;
};
...
/** Loop 循环*/
Game_Interpreter.prototype.command020 = function() {
    //返回 true
    return true;
};

/** Repeat Above 重复上述*/
Game_Interpreter.prototype.command021 = function() {
    //运行{
    this.skipBranch();
    //返回 true
    return true;
...
/** Break Loop 断开循环*/
Game_Interpreter.prototype.command030 = function() {
    //当(索引 < 列表 长度 - 1 )
...
/**安装子项*/
Game_Interpreter.prototype.setupChild = function(obj) {
...
/** la 标签*/
Game_Interpreter.prototype.command031 = function() {
    //返回 true 
    return true;
};

/** Jump to Label 跳到标签*/
Game_Interpreter.prototype.command032 = function() {
    //标签名 = 参数[0]
    this.skipBranch();
    //返回 true
    return true;
...
Game_Interpreter.prototype.command034 = function() {
    //索引 = 列表 长度 
