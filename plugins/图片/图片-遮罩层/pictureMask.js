 ...
 * @example
 * 
 * $gameScreen.showPicture(1,"0",0,0,0,100,100,255,0)
 * 设置遮罩 
 * $gameScreen.maskPicture(1,"1")
 * 改变遮罩色调来实现渐变效果 (渐隐)
 * $gameScreen.maskPictureTone(1,[-255,-255,-255,255],100)
 * 改变遮罩色调来实现渐变效果 (渐显)
 * $gameScreen.maskPictureTone(1,[255,255,255,0],100)
 * 
 */
...
(function () {
    ...
    ww.pictureMask.Sprite_Picture_prototype_update = Sprite_Picture.prototype.update
    Sprite_Picture.prototype.update = function () {
        ww.pictureMask.Sprite_Picture_prototype_update.call(this);
        if (this.visible) {
            this.updateMask();
        }
    };
    ...
    ww.pictureMask.Game_Picture_prototype_update = Game_Picture.prototype.update
    Game_Picture.prototype.update = function () {
        ww.pictureMask.Game_Picture_prototype_update.call(this)
        this.updateMask()
    };
