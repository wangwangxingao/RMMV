...
Window_Base.prototype.calcTextHeight = function () {
    ...
    var out = this.contents.outlineWidth
    var textHeight = maxFontSize + out * 2;
    return textHeight;
};
...
Window_Base.prototype.tslPushEscapeCharacter = function (textState, code) {
    switch (code) {
        ...
        case 'TWH':
            ...
            break
        case 'MOVE':
            this.makeMove(this.obtainEscapeParamExs(textState), textState);
            break;
        case 'PS':
        case 'PM':
        case 'PO':
...
Window_Base.prototype.tslPushWH = function (textState, list) {
    ...
    if (textState && textState.page && textState.page.set) {
        textState.page.set.w = w
        textState.page.set.h = h
    }
    var obj = {
        "type": "wh",
        "value": list
