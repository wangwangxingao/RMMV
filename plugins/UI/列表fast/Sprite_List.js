...
Sprite_UIList.prototype.__pagetoO = [{ fr: { opacity: 200 }, t: 0 }, 30, { t: 50, up: { opacity: -5 } }]
...
Sprite_UIList.prototype.showToY = function (y) {
    this._showY = Math.min(Math.max(y, 0), Math.max(this._allH - this._showH, 0))
